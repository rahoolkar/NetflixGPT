...
import { toggleGptBtn } from "../utils/GPTBtnSlice";
...
function BrowseHeader() {
  ...
  return (
    <div className="fixed top-0 w-full bg-gradient-to-b from-black z-99 flex justify-between">
      <img className="h-24 mx-20" src={NETFLIX_LOGO_IMG} alt="netflix-logo" />
      <div className="flex items-center">
        <div className="p-4">
          <button
            className="bg-blue-800 text-white font-bold p-4 m-2 rounded-lg"
            onClick={handleGPTClick}
          >
            {showGptBtn ? "Home" : "Search GPT"}
          </button>
        </div>
